...
#url = "https://www.javdatabase.com/idols/hitomi-hitomi-tanaka/"
...
def extract_data_videos():
    for video in idolVideos:
        code = video.find('a', class_='cut-text').text
        codeList.append(code)


scrape = ['Age:', 'DOB:', 'Birthplace:', 'Sign:', 'Blood:', 'Measurements:', 'Cup:', 'Height:', 'Shoe Size:']
label = ['age', 'dob', 'birthplace', 'zodiac', 'blood', 'size3', 'cup', 'height', 'shoe']
